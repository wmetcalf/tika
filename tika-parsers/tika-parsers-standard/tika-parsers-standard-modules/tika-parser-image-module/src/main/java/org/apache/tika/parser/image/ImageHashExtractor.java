...
/**
 * Computes hashes compatible with Python imagehash phash() and colorhash(binbits=4).
 */
class ImageHashExtractor {
    ...
    static String computePhash(BufferedImage img) {
    ...
    static String computeColorHash(BufferedImage src) {
